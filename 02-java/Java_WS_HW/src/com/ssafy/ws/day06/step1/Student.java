package com.ssafy.ws.day06.step1;
 ...
 * 
 * 실습 순서 1) Person 클래스 구현 2) Student 클래스 구현 3) Teacher 클래스 구현
 */
...
//		this(null, 0, track, region, classNumber);
		this.track = track;
		this.region = region;
