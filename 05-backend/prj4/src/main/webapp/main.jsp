						...
						<div class="modal-body">
							...
							<input type="hidden" name="action" value="register" />
								...
								<div class="mb-3">
								    ...
								    <input type="text" class="form-control" id="cellPhone" name="phone" placeholder="010-1234-1234" maxlength="13" required onkeyup="formatPhoneNumber(event)">
								</div>
								<div class="mb-3">
